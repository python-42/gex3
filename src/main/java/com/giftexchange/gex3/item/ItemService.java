...
public class ItemService {
    ...
    public static String itemForm(ItemRepository itemRepository, WebsocketFormData data, String name){
        ...
        String id = data.getDataPart(0);
        dataMap.put("name", data.getDataPart(1));
        dataMap.put("url", data.getDataPart(2));
        dataMap.put("title", data.getDataPart(3));
        dataMap.put("comment", data.getDataPart(4));
        ...
        if(id.equals("")){
            ...
            if(itemRepository.itemOwnerById(Integer.valueOf(id)).equals(name)){
