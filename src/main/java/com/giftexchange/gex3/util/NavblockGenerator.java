...
public class NavblockGenerator {
    ...
    type - 'active' if this button should have the active class and not redirect user or 'shown' if the button should redirect the user
     ...
     */
    public static String generateNavblock(List<Map<String, String>> pages){
        String rtn = "";
