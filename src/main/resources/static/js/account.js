import WebsocketForm from "./WebsocketForm.js";
    ...
    $(function () {
        ...
        stompClient.connect({}, ()=> {
            ...
            PasswordForm = new WebsocketForm(stompClient, "/socket/account/password", "/app/account/password", "passwordForm", "#passwordForm", "#password-error-div", ["#current-box", "#new-box", "#confirm-box"]);
        });
